...
# treasures and finds the exit using a FIFO Queue.
...
class BFS:
    def __init__(self) -> None:
        # _labyrinth represents a list of lists,
        # each sublist contains costs of tiles in
        # labyrinth
        self._labyrinth = []
        self._drawer = None
    ...
    def _search(self, start_node, end_node, treasures) -> tuple:
        ...
        # Initialize counters and route list
        cost = 0
        checked = 0
        route = []
        ...
        # Set start node as already visited
        x, y = start
        visited[y][x] = True

        # Start node is first in queue
        queue = [start_node]
        ...
        while queue:
            ...
            # If current node is end and all treasures found
